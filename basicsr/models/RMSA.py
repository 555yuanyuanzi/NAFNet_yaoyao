...
class RotaryMotionAwareSkipAlignment(nn.Module):
    """
    Rotary motion-aware skip gate for encoder-decoder fusion.

    The module projects decoder and skip features into a rotary phase space,
    uses their phase discrepancy and correlation to predict a residual gate for
    skip feature injection. It keeps the original skip addition at
    initialization:
        out = x_dec + x_skip
    """
